...
always @(*) begin
    if (is_night <= 16'h8000) begin
        ...
        if (kde_prob_night_mean <= 16'h4773) begin
            ...
            if (kde_prob_night_mean <= 16'h5F44) begin
                if (kde_prob_night_mean <= 16'h5831) begin
                    if (mean_speed <= 16'h5AA0) begin
                        tree_out = 1'b0;
                    end else begin
                        tree_out = 1'b1;
                    end
                end else begin
                    if (accelerate <= 16'h5502) begin
                        tree_out = 1'b0;
                    end else begin
                        tree_out = 1'b1;
                    end
                ...
                if (accelerate <= 16'h5E72) begin
                    if (step_median <= 16'h2C1C) begin
                        tree_out = 1'b0;
                    end else begin
                        tree_out = 1'b0;
                    end
                end else begin
                    if (mean_speed <= 16'h4992) begin
                        tree_out = 1'b0;
                    end else begin
                        tree_out = 1'b1;
                    end
