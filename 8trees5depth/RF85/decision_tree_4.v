    ...
    if (kde_prob_night_mean <= 16'h4498) begin
        if (kde_prob_mean <= 16'h19C8) begin
            if (turning_angle_max <= 16'hED84) begin
                ...
                if (kde_prob_mean <= 16'h1916) begin
                    tree_out = 1'b1;
                end else begin
                    tree_out = 1'b0;
                end
            ...
            if (step_median <= 16'h2EC2) begin
                ...
                if (turning_angle_median <= 16'h1C13) begin
                    tree_out = 1'b1;
                end else begin
                    tree_out = 1'b0;
                end
        ...
        if (step_median <= 16'h31FA) begin
            if (kde_prob_mean <= 16'h193C) begin
                tree_out = 1'b1;
            end else begin
                if (kde_prob_night_mean <= 16'hE02C) begin
                    if (accelerate <= 16'h0001) begin
                        tree_out = 1'b0;
                    end else begin
                        tree_out = 1'b0;
                    end
            ...
            if (kde_prob_mean <= 16'h5194) begin
                if (mean_speed <= 16'h468A) begin
                    tree_out = 1'b0;
                end else begin
                    if (mean_speed <= 16'h6782) begin
                        tree_out = 1'b1;
                    end else begin
                        tree_out = 1'b1;
                    end
