...
always @(*) begin
    if (kde_prob_night_mean <= 16'h41AE) begin
        if (kde_prob_night_mean <= 16'h353C) begin
            if (dist_to_centroid_mean <= 16'h82FD) begin
                if (step_median <= 16'h0748) begin
                    ...
                    if (dist_to_centroid_mean <= 16'h5BA2) begin
                        tree_out = 1'b1;
                    end else begin
                        tree_out = 1'b1;
                    end
            ...
            if (is_night <= 16'h8000) begin
                ...
                if (turning_angle_median <= 16'hE8F4) begin
                    if (kde_prob_night_mean <= 16'h3750) begin
                        tree_out = 1'b0;
                    end else begin
                        tree_out = 1'b1;
                    end
        ...
        if (accelerate <= 16'h51E2) begin
            if (mean_speed <= 16'h8290) begin
                if (dist_to_centroid_mean <= 16'h7EB7) begin
                    if (kde_prob_mean <= 16'h197A) begin
                        tree_out = 1'b1;
                    end else begin
                        tree_out = 1'b0;
                    end
                end else begin
                    if (turning_angle_median <= 16'h1588) begin
                        tree_out = 1'b1;
                    end else begin
                        tree_out = 1'b0;
                    end
                ...
                if (accelerate <= 16'h2498) begin
                    if (mean_speed <= 16'h8CAD) begin
                        tree_out = 1'b1;
                    end else begin
                        tree_out = 1'b0;
                    end
            ...
            if (mean_speed <= 16'h2646) begin
                tree_out = 1'b0;
            end else begin
                if (kde_prob_night_mean <= 16'h7D64) begin
                    if (is_night <= 16'h8000) begin
                        tree_out = 1'b0;
                    end else begin
                        tree_out = 1'b1;
                    ...
                    if (turning_angle_max <= 16'h3577) begin
                        tree_out = 1'b1;
                    end else begin
                        tree_out = 1'b0;
                    end
