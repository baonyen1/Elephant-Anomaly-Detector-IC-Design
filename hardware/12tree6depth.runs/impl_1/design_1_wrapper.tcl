namespace eval ::optrace {
  variable script "D:/12tree6depth/12tree6depth.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/12tree6depth/12tree6depth.cache/wt [current_project]
  set_property parent.project_path D:/12tree6depth/12tree6depth.xpr [current_project]
  set_property ip_repo_paths d:/12tree6depth [current_project]
  update_ip_catalog
  set_property ip_output_repo D:/12tree6depth/12tree6depth.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/12tree6depth/12tree6depth.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/12tree6depth/design_1/design_1.bd
